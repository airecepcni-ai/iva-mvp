...
export default defineConfig({
  ...
  ssr: {
    target: 'node',
    // External packages that must NOT be bundled (to ensure single instance)
    // @neondatabase/serverless must be external so neonConfig can be configured before any module uses it
